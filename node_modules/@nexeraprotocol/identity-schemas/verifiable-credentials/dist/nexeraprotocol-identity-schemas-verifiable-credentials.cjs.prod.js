...
var kyc_schema = require('../../dist/kyc.schema-a594ef57.cjs.prod.js');
require('zod');
...
var extractFields = function extractFields(props) {
  ...
  var _loop = function _loop() {
    ...
    } else if (kyc_schema.SupportedType.safeParse(property.type).success) {
      ...
      fields.push({
        ...
        availableOperators: function () {
          switch (property.type) {
            case "string":
              return kyc_schema._toConsumableArray(kyc_schema.STRING_OPERATORS);
            case "integer":
              return kyc_schema._toConsumableArray(kyc_schema.NUMERIC_OPERATORS);
            case "number":
              return kyc_schema._toConsumableArray(kyc_schema.NUMERIC_OPERATORS);
            case "boolean":
              return kyc_schema._toConsumableArray(kyc_schema.BOOLEAN_OPERATORS);
            case "array":
              return kyc_schema._toConsumableArray(kyc_schema.ARRAY_OPERATORS);
            default:
...
exports.CredentialMediaType = kyc_schema.CredentialMediaType;
exports.CredentialNames = kyc_schema.CredentialNames;
exports.CredentialSchemas = kyc_schema.CredentialSchemas;
exports.CredentialType = kyc_schema.CredentialType;
exports.CredentialTypes = kyc_schema.CredentialTypes;
exports.GenericVerifiableCredentialSchema = kyc_schema.GenericVerifiableCredentialSchema;
exports.ID3CredentialSubjectSchema = kyc_schema.ID3CredentialSubjectSchema;
exports.IDImageCredentialSubjectSchema = kyc_schema.IDImageCredentialSubjectSchema;
exports.IDInformationCredentialSubjectSchema = kyc_schema.IDInformationCredentialSubjectSchema;
exports.IDScanCredentialSubjectSchema = kyc_schema.IDScanCredentialSubjectSchema;
exports.IDScanPassportCredentialSubjectSchema = kyc_schema.IDScanPassportCredentialSubjectSchema;
exports.IDScanSelfieCredentialSubjectSchema = kyc_schema.IDScanSelfieCredentialSubjectSchema;
exports.ISO3CountryCode = kyc_schema.ISO3CountryCode;
exports.NexeraCredentialType = kyc_schema.NexeraCredentialType;
exports.OLD_AMLScreeningsResultsCredentialSubjectSchema = kyc_schema.OLD_AMLScreeningsResultsCredentialSubjectSchema;
exports.OLD_IDImageCredentialSubjectSchema = kyc_schema.OLD_IDImageCredentialSubjectSchema;
exports.OLD_IDInformationCredentialSubjectSchema = kyc_schema.OLD_IDInformationCredentialSubjectSchema;
exports.OLD_ProofOfResidenceCredentialSubjectSchema = kyc_schema.OLD_ProofOfResidenceCredentialSubjectSchema;
exports.OLD_SelfieImageCredentialSubjectSchema = kyc_schema.OLD_SelfieImageCredentialSubjectSchema;
exports.ProofOfResidenceCredentialSubjectSchema = kyc_schema.ProofOfResidenceCredentialSubjectSchema;
exports.SelfieImageCredentialSubjectSchema = kyc_schema.SelfieImageCredentialSubjectSchema;
exports.VerifiableCredential = kyc_schema.VerifiableCredential;
exports.countryISO3toISO2Mapping = kyc_schema.countryISO3toISO2Mapping;
exports.getCredentialName = kyc_schema.getCredentialName;
