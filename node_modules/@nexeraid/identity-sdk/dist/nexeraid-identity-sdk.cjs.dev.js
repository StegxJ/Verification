...
var identitySchemas = require('@nexeraprotocol/identity-schemas');
var identity = require('@nexeraprotocol/identity-schemas/identity');
...
var buildSignatureMessage = function buildSignatureMessage(address) {
  var parsedAddress = identitySchemas.BlockchainAddress.parse(address);
          ...
          return _regeneratorRuntime().wrap(function _callee5$(_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                ...
                identityMessage = identity.IdentityMessage.safeParse(event.data);
              ...
              case 32:
                if ((_this$callbacks3 = _this.callbacks) !== null && _this$callbacks3 !== void 0 && _this$callbacks3.kycCompletionCallback) {
                  _this.callbacks.kycCompletionCallback(identity.KycCompletionData.parse(identityMessageData.data));
              ...
              case 34:
                if ((_this$callbacks4 = _this.callbacks) !== null && _this$callbacks4 !== void 0 && _this$callbacks4.scenarioExecutionCallback) {
                  ...
                  parsedData = identity.ScenarioExecutionData.parse(identityMessageData.data);
...
exports.buildSignatureMessage = buildSignatureMessage;
